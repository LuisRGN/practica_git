// Intercambio de dulces justos

// // ---------------------------------------------------------
// Alice y Bob tienen una cantidad total diferente de dulces.
// Se le dan dos matrices de números enteros aliceSizes y bobSizes donde aliceSizes[i]
// es el número de caramelos de la i-ésima caja de caramelos que tiene Alice y bobSizes[j]
// es el número de caramelos de la j-ésima caja de caramelos que tiene Bob.

// Como son amigos, les gustaría intercambiar una caja de dulces cada uno para que después del intercambio, ambos tengan la misma cantidad total de dulces.
// La cantidad total de dulces que tiene una persona es la suma del número de dulces que tiene en cada caja.

// Devuelve una respuesta de matriz entera donde la respuesta [0] es la cantidad de dulces en la caja que Alice debe intercambiar y la respuesta [1] es la cantidad de dulces en la caja que Bob debe intercambiar.
// Si hay varias respuestas, puede devolver cualquiera de ellas. Se garantiza que existe al menos una respuesta.
...
/*
otros ejercios que busque xD .... mas ejercicios y mas 
...
7) Programa una función que valide si una palabra o frase dada, es un palíndromo (que se lee igual en un sentido que en otro), pe. 
...
10) Programa una función que reciba un número y evalúe si es capicúa o no (que se lee igual en un sentido que en otro), pe. 
...
12) Programa una función que determine si un número es primo (aquel que solo es divisible por sí mismo y 1) o no, pe. 
